      ...
      <main className="main-content">
        <header className="header">
          ...
          <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
            ...
            <div style={{ width: '32px', height: '32px', borderRadius: '50%', background: 'var(--primary-color)', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold' }}>A</div>
          </div>
        </header>
